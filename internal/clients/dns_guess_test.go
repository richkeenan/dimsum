...
func TestDNSGuessCorroborationAndExpiry(t *testing.T) {
	...
	cases := []struct {
		...
		{"Ring firmware complementary domains", []DNSActivity{{Domain: "fw-eventstream.prod.gws.ring.amazon.dev", First: now, Last: now, Count: 1}, {Domain: "fw.prod.gws.ring.amazon.dev", First: now, Last: now, Count: 1}}, "Ring device"},
		{"Ring firmware single query", []DNSActivity{{Domain: "fw.prod.gws.ring.amazon.dev", First: now, Last: now, Count: 1}}, ""},
		{"Ring firmware suffix spoof", []DNSActivity{{Domain: "fw.prod.gws.ring.amazon.dev.example.org", First: ring.First, Last: now, Count: 20}}, ""},
		{"Ring login service", []DNSActivity{{Domain: "devices.oauth.ring.com", First: ring.First, Last: now, Count: 20}}, ""},
